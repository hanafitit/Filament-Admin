    ...
    */
    ...
    'connections' => [
        ...
        'pgsql_local' => [
            ...
            'database' => env('LOCAL_DB_DATABASE', 'freelance_crm'),
            'username' => env('LOCAL_DB_USERNAME', 'postgres'),
            'password' => env('LOCAL_DB_PASSWORD', ''),
            'charset' => env('LOCAL_DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => env('LOCAL_DB_SCHEMA', 'public'),
            'sslmode' => env('LOCAL_DB_SSLMODE', 'prefer'),
        ],
        ...
        'pgsql_remote' => [
            ...
            'database' => env('REMOTE_DB_DATABASE', 'postgres'),
            'username' => env('REMOTE_DB_USERNAME', 'postgres'),
            'password' => env('REMOTE_DB_PASSWORD', ''),
            'charset' => env('REMOTE_DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => env('REMOTE_DB_SCHEMA', 'public'),
